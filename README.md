# :currency_exchange: Currency Converter Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/)

<img align="right" width="35%" height="auto" src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/JaJuMa-Currency-Converter-Power-Toy-For-Magento-2-small.png">  

Currency Converter Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/en) is a quick action toy 
that converts values from one currency to another.  
Conversion rates provided by [Open Exchange Rates API](https://openexchangerates.org/).
...
This Quick Action Power Toy provides:
* Currency conversion
...
<td>
    <table>
     <tr>
        <td><b>Currency Converter Toy</b><br>Dark Mode</td>
        <td><b>Currency Converter Toy</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Currency-Converter-Power-Toy-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Currency-Converter-Power-Toy-Light.jpg"></td>
    </tr>
     <tr>
        <td><b>Conversion Popup</b><br>Dark Mode</td>
        <td><b>Conversion Popup</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Currency-Converter-Power-Toy-Conversion-PopUp-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Currency-Converter-Power-Toy-Conversion-PopUp-Light.jpg"></td>
    </tr>
    </table>
</td>
...
* Open Exchange Rates API Key (free or paid)
...
```
composer require jajuma/pot-currency-converter
```

## Using Currency Converter Power Toy For Magento

After installing this module:  
Go to   
**JaJuMa -> Power Toys -> Configuration**  
and enable & configure Currency Conversion Toy.  
(Get a free API key on the [Open Exchange Rates website](https://openexchangerates.org/signup))
...
displaying the Currency Conversion Toy.  
A click on Currency Converter Toy will open the currency conversion popup.

* [See Manual for more details](https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/manuals/JaJuMa_Currency_Converter_Power_Toy_Manual_v001.pdf)


## License

The code is licensed under the [MIT License (MIT)](https://github.com/JaJuMa/pot-currency-converter/blob/master/LICENSE)
